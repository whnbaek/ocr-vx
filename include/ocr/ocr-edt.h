...
u8 ocrAddDependence_site(ocrGuid_t source, ocrGuid_t destination, u32 slot,
	ocrDbAccessMode_t mode, const char* file, int line);
#define ocrAddDependence(SRC,DST,SLOT,MODE) ocrAddDependence_site(SRC,DST,SLOT,MODE,__FILE__,__LINE__)
#else
